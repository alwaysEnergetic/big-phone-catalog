...
const HeaderBar = (props) => {
  ...
  return (
    <div className="w-full my-12 flex align-center cursor-pointer justify-between">
      ...
      <div className="flex w-4/12 items-center justify-center lg:text-lg md:text-sm sm:text-xs">Price</div>
      <div className="flex w-4/12 items-center justify-center lg:text-lg md:text-sm sm:text-xs">Count</div>
    </div>
  );
};
